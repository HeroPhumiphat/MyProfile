            ...
            <main>
                <div className='w-full mt-8 flex flex-col items-center space-y-2'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <Link href='https://github.com/HeroPhumiphat' className='flex space-x-2 items-center'><p className='ml-1'>github.com/HeroPhumiphat</p></Link>
                    </div>
                    <br />
                    <div className='text-lg font-bold'>
                        <h1 className='mb-0.5 mx-5 up'>Nextjs</h1>
